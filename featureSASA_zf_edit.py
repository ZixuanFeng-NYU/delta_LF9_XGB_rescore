...
msmsdir = "/home/zf2012/delta_LinF9_XGB/software/msms"
def runMSMS(inprot, inlig, MSMSDIR = '.'):
    ...
    if not os.path.isfile("./atmtypenumbers"):
        os.system("cp " + os.path.join(msmsdir,"atmtypenumbers") + " .")
        print("File copied successfully.")
    else:
        print("File already exists in destination directory, skipping copy.")
